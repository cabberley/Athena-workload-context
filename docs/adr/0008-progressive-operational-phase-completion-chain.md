# ADR 0008: Chain progressive operational phases through version-pinned completion indexes
...
ADR 0007 required baseline, inject, and reset receipts to exist before any phase could run. That is
...
index. Existing WC-013 and ARGUS contracts remain unchanged. Rollback restores the ADR 0007
