...
module inventoryCoreValidationGate 'modules/monitoring-publication-validation-gate.bicep' = {
  ...
  params: {
    ...
    failureMessage: 'monitoring contract publication requires a fresh v5 inventory with workload-RG Resource Graph query and per-VM Resource Health authorization evidence'
  }
}
