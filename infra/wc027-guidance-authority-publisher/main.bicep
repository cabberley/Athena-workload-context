...
var validatedEnrichmentRuntimeConfiguration = parsedEnrichmentRuntimeConfiguration.schemaVersion == 'athena.wc027EnrichmentFeedRuntimeConfiguration.v2' && parsedEnrichmentRuntimeConfiguration.monitoringCollectorContract.schemaVersion == 'athena.wc028MonitoringCollectorContract.v10' && parsedEnrichmentRuntimeConfiguration.monitoringCollectorContract.acquisitionReceiptSchemaVersion == 'athena.wc028MonitoringAcquisitionReceipt.v6' && parsedEnrichmentRuntimeConfiguration.monitoringAcquisitionAuthority.schemaVersion == 'athena.wc028MonitoringAcquisitionAuthority.v6' && parsedEnrichmentRuntimeConfiguration.monitoringAcquisitionAuthority.authorityDigest == parsedEnrichmentRuntimeConfiguration.monitoringAcquisitionAuthorityDigest && parsedEnrichmentRuntimeConfiguration.monitoringAcquisitionAuthority.collectorContractDigest == parsedEnrichmentRuntimeConfiguration.monitoringCollectorContractDigest
  ? parsedEnrichmentRuntimeConfiguration
  : fail('guidance publication requires the exact WC-027 v2 runtime and WC-028 v9 collector contract; legacy v3-v8 must be recollected and republished')
